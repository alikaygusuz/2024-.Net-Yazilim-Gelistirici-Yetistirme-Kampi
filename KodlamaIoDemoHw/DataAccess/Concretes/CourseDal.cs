    ...
    internal class CourseDal : ICourseDal
    {
        ...
        public CourseDal()
        {
            courses = new List<Course>() {
                new Course { CourseName="C#,",CourseId=1,CourseDescription="C# İleri Seviye Programla Eğitimi",InstructorId=1,CategoryId=1,ImagePath="csharp.png", CourseProces=10},
                 new Course { CourseName="JAVA,",CourseId=2,CourseDescription="JAVA İleri Seviye Programlama Eğitimi",InstructorId=3,ImagePath="java.png",CategoryId=2, CourseProces=38 }
            };
